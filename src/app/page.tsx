...
export default function Home() {
  ...
  const handleCheckout = useCallback(async () => {
    ...
    try {
      ...
      if (invoiceSupported) {
        ...
        webApp?.showAlert(
          "Some features not available. Please update your telegram app!"
        );
      }
    } catch (_) {
  ...
  useEffect(() => {
    ...
    if (state.mode === "order") webApp?.MainButton.setText("CHECKOUT");
    else webApp?.MainButton.setText("VIEW ORDER");
  }, [state.mode]);
